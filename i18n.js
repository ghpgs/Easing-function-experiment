...
export const TEXT = {
    ja: {
        ...
        tutorialInfo: (item) => `【チュートリアル】「${item}」をメニューから見つけて、クリックしてください。`,
        tutorialWrong: "チュートリアル：違う項目です。",
        tutorialTimeout: "（チュートリアル：時間切れです もう一度トライ可能）",
        tutorialCorrect: "チュートリアル：正解です！",
        taskInfo: (idx, max, item) => `タスク ${idx}/${max}： 「${item}」をメニューから見つけて、クリックしてください。`,
    ...
    en: {
        ...
        tutorialInfo: (item) => `[Tutorial] Please find "${item}" from the menu and click it.`,
        tutorialWrong: "Tutorial: Incorrect item.",
        tutorialTimeout: "(Tutorial: Time out. Please try again.)",
        tutorialCorrect: "Tutorial: Correct!",
        taskInfo: (idx, max, item) => `Task ${idx}/${max}: Find "${item}" from the menu and click it.`,
        ...
        resultTitle: "Results",
        resultTask: "Task No.",
        resultItem: "Correct Item",
        resultTime: "Time (s)",
        resultError: "Errors",
        resultTimeout: "Timeout",
        resultEasing: "Easing Used",
        timeoutYes: "Yes",
        timeoutNo: "No",
